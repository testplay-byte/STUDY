 ...
 *   Books/Digital/<BATCH>-page-NNN.html (FLAT) + assets/ — hand-typeset replica test edition
 *     (8-page user-approved whitelist; checked by check-digital-test.mjs — CONVENTIONS §1.5)
 *
...
for (const [subject, meta] of Object.entries(BOOKS)) {
  ...
  idx += `> Digital replica test edition: \`Books/Digital/\` — 8 hand-typeset pages (\`<BATCH>-page-NNN.html\` + assets/, user-approved whitelist; see docs/CONVENTIONS.md §1.5).\n`;
  for (const part of meta.parts) {
