...
const BATCHES = [
  ...
  { batch: 'M-9', subject: 'mathematics', subjectDir: 'Mathematics', rawName: 'Unit-09-Solution-of-Trigonometric-Equations',      oldFolder: null, newFolder: 'Chapter-09-Solution-of-Trigonometric-Equations',      imgs: 12, markdownOnly: true },
  { batch: 'M-10', subject: 'mathematics', subjectDir: 'Mathematics', rawName: 'Unit-10-Numerical-Methods',                        oldFolder: null, newFolder: 'Chapter-10-Numerical-Methods',                        imgs: 16, markdownOnly: true },
  { batch: 'M-BM', subject: 'mathematics', subjectDir: 'Mathematics', rawName: 'Back-Matter',                                   oldFolder: null, newFolder: 'Chapter-99-Back-Matter',                                   imgs: 27, markdownOnly: true },
